...
/**
 * Servlet implementation class BoardCategoryAllServlet
 */
@WebServlet("/boardAll")
public class BoardCategoryAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BoardCategoryAllServlet() {
		super();
...
//					currentPage = Integer.valueOf( request.getParameter("page") );
		...
		request.getRequestDispatcher("/WEB-INF/BoardAll.jsp").forward(request, response);
	}
