...
/**
 * Servlet implementation class BoardListActionServlet
 */
...
//					currentPage = Integer.valueOf( request.getParameter("page") );
		...
		// 총 글수
		bCount = new BoardService().getBoardCount(search, item);
		...
		ArrayList<Board> volist = new BoardService().getBoardList(item, startRnum, endRnum, search);
		...
		request.getRequestDispatcher("/WEB-INF/BoardSearch.jsp").forward(request, response);
	}
