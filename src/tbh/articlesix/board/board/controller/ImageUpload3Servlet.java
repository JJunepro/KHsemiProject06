...
/**
 * Servlet implementation class ImageUpload3Servlet
 */
@WebServlet("/imageUpload3")
public class ImageUpload3Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ImageUpload3Servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fileSavePath = "./upload/board";
