					...
					<tbody>
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control"
								placeholder="글 제목" name="bn_title" maxlength="50"
								value="<%=bnn.getBn_title()%>"></td>
						</tr>
						<tr>
							<td colspan="1" class="table_title">닉네임</td>
							<td colspan="3"><input type="text" class="form-control"
								placeholder="작성자" name="m_nick" maxlength="50"
								value="<%=bnn.getM_nick()%>"></td>
						</tr>
						<tr>
							<td colspan="4"><textarea cols="100" rows="10"
									name="bn_content" id="editor" placeholder="글 내용"
									maxlength="2048"><%=bnn.getBn_content()%></textarea></td>
							<script>
