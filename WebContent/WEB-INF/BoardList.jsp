		...
		<div id="board-list">
			<div class="container">
				<table class="board-table">
					...
					<tbody>
						<tr>
							<td><a href="boardcontent?no=<%=vo.getBno()%>"><%=vo.getBno()%></a>
							</td>
							<td><a href="boardcontent?no=<%=vo.getBno()%>"><%=vo.getTitle()%></a>
							</td>
							<td><a href="boardcontent?no=<%=vo.getBno()%>"><%=vo.getWriter()%></a>
							</td>
							<td><a href="boardcontent?no=<%=vo.getBno()%>"><%=vo.getCreateDate()%></a>
							</td>
						</tr>
						<%
               			}
