...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<% String bf_n = request.getParameter("bf_n");%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
				...
				<table class="table table-striped" style="text-align:center; border:1px solid #dddddd;">
					...
					<tbody>
						<tr>
							...
							<td colspan="3" ><input type="text" class="form-control" placeholder="글 제목" name="bf_title" maxlength="50"></td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="4"><textarea cols="100" rows="10" name="bf_content" id="editor" placeholder="글 내용" maxlength="2048"></textarea></td>
