...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%
	String bq_n = request.getParameter("bq_n");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="questionwrite.do">
				...
				<table class="table table-striped"
					...
					<thead class="title">
						<tr>
							<th colspan="4"
								style="background-color: #eeeeee; text-align: center;">QnA
								글쓰기 양식</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control"
								placeholder="글 제목" name="bq_title" maxlength="50"></td>
						</tr>
						<tr>
							<td colspan="1" class="table_title"><span>작성자</span></td>
							<td colspan="3"><input type="text" class="form-control"
								placeholder="작성자" name="m_nick" maxlength="50"></td>
						</tr>
						<tr>
							<td colspan="4"><textarea cols="100" rows="10"
									name="bq_content" id="editor" placeholder="글 내용"
