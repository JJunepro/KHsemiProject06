	...
	<div class="container">
		<div class="row">
			<form method="post" action="boardmodify">
				...
				</select> <input type="hidden" name="no" value="<%=bno.getBf_n()%>">
					...
					<tbody>
						<tr>
							...
							<td colspan="3"><input type="text" class="form-control"
								placeholder="글 제목" name="bf_title" maxlength="50"
								value="<%=bno.getBf_title()%>"></td>
						</tr>
						<tr>
							<td colspan="1" class="table_title">작성자</td>
							<td colspan="3"><input type="text" class="form-control"
								placeholder="작성자" name="m_nick" maxlength="50"
								value="<%=bno.getM_nick()%>"></td>
						</tr>
						<tr>
							<td colspan="4"><textarea cols="100" rows="10"
									name="bf_content" id="editor" placeholder="글 내용"
									maxlength="2048"><%=bno.getBf_content()%></textarea></td>
							<script>
