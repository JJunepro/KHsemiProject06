...
<%
	Recruit rcdetail = (Recruit) request.getAttribute("recruitdetail");
%>
<!DOCTYPE html>
<html>
<head>
...
■풋살화 대여: O (245mm~, 3천 원)</pre>
							...
							<section class="section" id="rcMatch">
								...
								<div class="stadInner">
									...
									<ul class="matchRule">
										<h4>특수 (우천)</h4>
										<li>전날 기준 기상청 날씨누리 기준 해당 지역 1mm 이상의 예보가 있는 경우 매치 당일 00시
											부터 환급 기준이 변경 됩니다.</li>
										...
										<li>매치 시작 1시간 30분 전까지 취소하지 않고 불참하면 페어플레이 포인트가 차감되어 향후 이용에
											제한이 있습니다.</li>
										<li>매치 중 플레이가 어려울 정도로 비가 오는 경우에는 현장에서 매니저 판단하에 종료 될 수
											있으며, 진행되지 않은 시간만큼 부분 환급 처리됩니다.</li>
