				...
				<div class="search-window">
					<form action="noticelist.do" method="get">
						<div class="search-wrap">
							...
							</select> <label for="search" class="blind">동네 소개/홍보 검색</label> <input
			...
			<div class="container">
				...
				<div class="pageController">
					<%
						if (startPage > 1) {
					%>
					<a href="./boardMeet?pagenum=<%=previous%>">이전</a>
					<%
						}
					for (int i = startPage; i <= endPage; i++) {
					%>
					<a href="./boardMeet?pagenum=<%=i%>"><%=i%></a>
					<%
						if (i != endPage) {
					%>
					<%
					...
					%>
					<a href="./boardMeet?pagenum=<%=next%>">다음</a>
					<%
						}
					%>
				</div>
